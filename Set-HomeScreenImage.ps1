...
function Set-HomeScreenImage {
    ...
    $themeWallpaperPath = Join-Path $localThemeDirectory 'CopilotWallpaper.bmp'
    $cachedWallpaperPath = Join-Path $localThemeDirectory 'CopilotWallpaper.jpg'
    $themeFilePath = Join-Path $localThemeDirectory 'CopilotCustom.theme'
